...
import {
    MonitorHourlyState,
    powerMonitorHourlyReducer,
} from './reducers/power-monitor.hourly.reducer';
import {
    MonitorDailyState,
    powerMonitorDailyReducer,
} from './reducers/power-monitor.daily.reducer';
import {
    MonitorMonthlyState,
    powerMonitorMonthlyReducer,
} from './reducers/power-monitor.monthly.reducer';
import {
    MonitorYearlyState,
    powerMonitorYearlyReducer,
} from './reducers/power-monitor.yearly.reducer';
import {
    FailuresHourlyState,
    powerFailuresHourlyReducer,
} from './reducers/power-failures.hourly.reducer';
import {
    FailuresDailyState,
    powerFailuresDailyReducer,
} from './reducers/power-failures.daily.reducer';
import {
    FailuresMonthlyState,
    powerFailuresMonthlyReducer,
} from './reducers/power-failures.monthly.reducer';
import {
    FailuresYearlyState,
    powerFailuresYearlyReducer,
} from './reducers/power-failures.yearly.reducer';
import {
...
} from './reducers/power-consumption.reducer';
