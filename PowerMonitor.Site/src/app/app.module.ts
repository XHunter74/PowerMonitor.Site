...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'platform-info', component: PlatformInfoComponent },
      { path: 'settings', component: BoardSettingsComponent, canActivate: [AuthGuard] },
      { path: 'power-monitor/hourly', component: PowerMonitorComponent, data: { name: 'hourly' } },
      { path: 'power-monitor/daily', component: PowerMonitorComponent, data: { name: 'daily' } },
      { path: 'power-monitor/monthly', component: PowerMonitorComponent, data: { name: 'monthly' } },
      { path: 'power-failures', component: PowerFailuresComponent },
      { path: 'voltage-amperage/hourly', component: VoltageAmperageComponent, data: { name: 'hourly' } },
